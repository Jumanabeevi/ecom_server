...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@yogaconnect.cr0eb.mongodb.net/?retryWrites=true&w=majority&appName=yogaconnect`;
...
async function run() {
    try {
        ...
        const database = client.db("yoga_connect");
